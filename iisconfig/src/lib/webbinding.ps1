function Add-WebBinding ( 
    ...
    # MS recommends waiting after adding a new web binding https://docs.microsoft.com/en-us/powershell/module/webadminstration/remove-webbinding?view=winserver2012-ps
